...
---
<div>
  <a id="single_image" href="lay/img/drzewko_big.jpg"><img
      src="lay/img/drzewko_min.jpg"
      alt="Śnieżny show"
  ...
  <table border="0">
    <tr>
      <td>
        <strong>Grają</strong><br/>Joanna Pietrońska, <br/> Patrycja Potyralska, <br/> Przemko Janiszko
      </td>
      <td>
        <strong>Muzyka</strong><br/>Krzysztof Gumienny</td>
      <td>
        <strong>Opracowanie muzyczne</strong><br/>Przemko Janiszko</td>
      <td>
        <strong>Scenografia i inscenizacja</strong><br/>Małgorzata Domańska</td>
      <td>
        <strong>Tekst</strong><br/>Pola Wójcik</td>
      <td>
        <strong>Wiersze</strong><br/>Leopolda Staffa i Williama Shakespeare'a ze Snu Nocy Letniej</td>
    </tr>
  </table>
  ...
  <ul class="photos">
    {% for i in (1..6) %}
      <a
        id="single_image"
        rel="drzewko"
        href="lay/img/drzewko/large/{{ i }}.jpg"><img src="lay/img/drzewko/small/{{ i }}.jpg" /></a>
    {% endfor %}
  </ul>
